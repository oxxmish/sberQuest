...
export default {
  ...
  data(){
    return {
      ...
      unique_products: [],
      state: {},
      current_question: ["В 1 раунде необходимо собрать максимальное количество цветных пазлов, верно отвечая на вопросы о продуктах ЭкоСистемы. 1 цвет = 1 верный ответ = 1 балл.\n\n  Во 2 раунде вопросы на проявление навыков, знаний процессов или общей категории. Количество баллов за верный ответ будет иным.\n\n  Полем управляет ведущий.\n  Всем удачи!", 'Приветствуем Вас на игре по ЭкоСистеме Сбера.', 'В 1 раунде необходимо собрать максимальное количество цветных пазлов, верно отвечая на вопросы о продуктах ЭкоСистемы.1 цвет = 1 верный ответ = 1 балл.\nЕсть 3 подсказки:\n- помощь других команд\n- замена вопроса\n- замена продукта (на следующий по часовой стрелке)\n\n  Во 2 раунде вопросы на проявление навыков, знаний процессов или общей категории. Количество баллов за верный ответ будет иным.\n\n  Над игровым полем 2 таймера - слева общее время игры, справа лимит для ответа на вопрос.\n\n  Полем управляет ведущий. Всем удачи!'],
      puzzles: [ 0, 0, 0, 0 ],
      scores: [ 0, 0, 0, 0 ],
      tour: 1,
      turn: -1,
